...
import testFW.pageobjects.CheckoutPage;
import testFW.pageobjects.ConfirmationPage;
import testFW.pageobjects.OrderPage;
...
public class SubmitOrderTest extends BaseTest {
	...
	public Object[][] getData() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				System.getProperty("user.dir") + "//src//test//java//testFW//data//PurchaseOrder.json");
